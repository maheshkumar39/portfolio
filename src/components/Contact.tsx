...
import { Mail, Phone, MapPin, Linkedin, Send, CheckCircle, ArrowRight } from 'lucide-react';
...
const socials = [
  { icon: GitHubIcon, label: 'GitHub', href: 'https://github.com/maheshkumar39', username: 'maheshkumar39' },
